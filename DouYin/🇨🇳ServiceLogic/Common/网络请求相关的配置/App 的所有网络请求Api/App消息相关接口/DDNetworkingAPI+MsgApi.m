...
#import "DDNetworkingAPI+MsgApi.h"
/*
 * App端接口文档
...
@implementation DDNetworkingAPI (MsgApi)

#pragma mark —— App消息相关接口
/// 消息二级级列表
NSString *messageSecondClassListGET;
...
/// 消息数量
NSString *selectMessageNumberGET;
+(void)selectMessageNumberGET:(id)parameters
                 successBlock:(MKDataBlock)successBlock{
//    NSDictionary *parameterss = @{};
//    NSDictionary *headers = @{};
    ...
    [ZBRequestManager requestWithConfig:^(ZBURLRequest * _Nullable request) {
        ...
        request.server = NSObject.BaseUrl;
        request.url = [request.server stringByAppendingString:NSObject.selectMessageNumberGET.url];
