//
//  DDNetworkingAPI+FriendsRelationshipApi.m
//  MonkeyKingVideo
//
...
#import "DDNetworkingAPI+FriendsRelationshipApi.h"
/*
 * App端接口文档
...
@implementation DDNetworkingAPI (FriendsRelationshipApi)

#pragma mark —— App好友关系相关接口
/// 手动执行奖励记录
NSString *addAwardGET;
...
/// selectUrl
NSString *friendUrlselectUrlGET;
...
//            request.keepType=ZBResponseKeepNone;
        ...
        if ([responseObject isKindOfClass:NSDictionary.class]) {
            ...
            if ([dic[@"code"] intValue] != 200) {
                [WHToast toastMsg:dic[@"msg"]];
            }
        }
    }];
}
/// 二期好友列表 GET
NSString *userFriendListGET;
