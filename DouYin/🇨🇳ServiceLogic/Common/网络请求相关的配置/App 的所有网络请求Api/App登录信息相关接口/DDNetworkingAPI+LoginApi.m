...
#import "DDNetworkingAPI+LoginApi.h"
/*
 * App端接口文档
...
@implementation DDNetworkingAPI (LoginApi)

#pragma mark —— App登录信息相关接口
/// 找回密码接口-重置密码
NSString *changePasswordPOST;
