...
@interface ZFPlayerPresentView1 : ZFPlayerView
...
@implementation ZFPlayerPresentView1
...
- (void)initializePlayer {
    ...
    ZFPlayerPresentView1 *presentView = (ZFPlayerPresentView1 *)self.view;
...
- (UIView *)view {
    if (!_view) {
        _view = [[ZFPlayerPresentView1 alloc] init];
    }
    return _view;
}
