...
#import "DDNetworkingAPI+BlankList.h"
/*
 * App端接口文档
...
@implementation DDNetworkingAPI (BlankList)

#pragma mark —— App黑名单相关接口
/// 添加
NSString *blackListAddPOST;
