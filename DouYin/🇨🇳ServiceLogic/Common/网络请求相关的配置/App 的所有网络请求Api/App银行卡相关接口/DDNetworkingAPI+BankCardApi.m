...
#import "DDNetworkingAPI+BankCardApi.h"
/*
 * App端接口文档
...
@implementation DDNetworkingAPI (BankCardApi)

#pragma mark —— App银行卡相关接口
/// 添加银行卡
NSString *bankAddPOST;
